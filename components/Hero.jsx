    ...
    return (
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
            <img className="justify-center shadow-[0px_10px_100px_10px] shadow-center shadow-[#701a75] scale-90 hover:scale-100 hover:shadow-2xl transition ease-in-out duration-500 object-cover object-center rounded" alt="hero" src="/images/vero.jpg"/>
          </div>
